...
namespace TheWall.Migrations
{
    ...
    [Migration("20241219195026_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheWall.Models.Comment", b =>
                {
                    b.HasOne("TheWall.Models.Message", "MessageCommentedOn")
                    ...
                    b.Navigation("MessageCommentedOn");
                });

            modelBuilder.Entity("TheWall.Models.Message", b =>
                {
                    b.HasOne("TheWall.Models.User", "Writer")
                        .WithMany("MyMessages")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TheWall.Models.Message", b =>
                {
                    b.Navigation("CommentsOnMessage");
                });
